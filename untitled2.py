...
Original file is located at
    https://colab.research.google.com/drive/1zGEMXX9GFlnxIJVQE_ArVy7SMjJ8oCBX
"""
...
data={
    "Ism": ['Ali', 'Vali', 'Sardor', 'Bonu', 'Guli', 'Ziyo', 'Zebo', 'Bek'],
    "Yoshi": [20, 21, 18, 19, 23, 22, 24, 25],
        'Shahar': ['Toshkent',  'Surxandaryo', 'Fargona', 'Andijon', 'Namangan', 'Fargona', 'Jizzax', 'Toshkent']
}
